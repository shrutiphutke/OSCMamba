...
if __name__ == '__main__':
    ...
    image_path = os.path.join("/content/drive/MyDrive/Shruti/MedMamba-main/Dataset/")  # flower data set path
    ...
    model_weight_path = "/content/drive/MyDrive/Shruti/MedMamba-main/model_nameNet.pth"
